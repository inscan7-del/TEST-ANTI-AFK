...
--// Uses the same Rebirth mechanism/requirements already present in the hub.
--// Only checks the local player.
    ...
    if blacklist[LocalPlayer.Name] then
        task.spawn(function()
            ...
            if leaderstats and strength and rebirths and muscleEvent and rebirthRemote then
                ...
                -- Use the same training event used by the hub until the
                -- normal Rebirth requirement is reached.
                ...
                -- Use the hub's normal Rebirth request and verify that
                -- the Rebirth counter actually changed.
